...
<head>
    ...
    border-radius: 5px;
        ...
        .contact-message {
            ...
            left: 5%;  /* Slight left margin */
            top: 50%;
            transform: translateY(-50%);
            text-align: left;
            transition: right 1s ease-in-out;  /* Transition effect */
        }

        /* Styling for heading and paragraphs inside the message */
        .contact-message h1, .contact-message h2, .contact-message p {
            margin: 0;
            padding: 5px 0;
        }

        /* Initial style for both divs */
        .contact-message {
            position: fixed;
            right: -100%;
        ...
        /* Clinic info message initially hidden */
        .clinic-info-message {
            display: none;
            opacity: 0;
        ...
        /* Style after sliding for the contact-message */
        .contact-message.slide-in {
            right: 0;
        }

        /* Show clinic-info-message after animation */
        .contact-message.show-info + .clinic-info-message {
            display: block;
            opacity: 1;
        }
        ...
        @media (max-width: 480px) {
            .contact-message {
                font-size: 13px;  /* Even smaller font size for mobile devices */
                padding: 3%;
                left: 2%;  /* Minimal left margin */
                max-width: 100%;  /* Take up more space on very small screens */
            }
        }
...
<body>
    ...
    <p>Welcome to Smart Dental Clinic, where we blend innovation with healthcare.</p>
    <p>Smart Dental Clinic was established in 2013 by Dr. Amimu Kilomoni, DDM from the Esteemed Ege University, Izmir, Turkey. Our clinic provides advanced dental care with a focus on improving oral health for all our patients.</p><br><br>
    
    <h2>Introducing iPemz - Developer</h2>
    <p>iPemz is the developer behind our cutting-edge digital solutions, ensuring that Smart Dental Clinic stays ahead with technology. With expertise in web development, software solutions, and digital innovation, iPemz plays a key role in enhancing the clinic's online presence and internal systems.</p>
    <p>As a developer, iPemz’s mission is to create seamless user experiences, build robust systems, and implement the latest technological advancements for the clinic. From developing our website to integrating patient management systems, iPemz ensures everything runs smoothly.</p>
    <p>If you need to contact iPemz, feel free to reach out via email at <a href="mailto:apembeally@gmail.com">apembeally@gmail.com</a>.</p>
</div>
