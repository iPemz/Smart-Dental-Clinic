...
<body>
    ...
    <div class="contact-message fade-in-up delay-2">
        ...
        <p>This clinic was started with the unique concept of treatment planning where the first priority were given to Sterilization and patient information, consultation and explanation of treatment and the follow up after treatment. Right from the days of establishment this clinic have strived and succeeded in providing dental care.</p>
        <p>Smart Dental Clinic was established in 2013 by Dr. Amimu Kilomoni, DDM from the Esteemed Ege University, Izmir, Turkey.</p><br><br>
            <strong>Mission and Policy</strong><br>
            <p>OUR MISSION - To be dental benefits company of choice in the market we serve.</p>
            <p>OUR AIMS - To advance and promote the improvement of Oral health.</p>
            <p>To provide ultimate treatment care for the large group of population as we recognised the need to increase the access to Oral health care.</p>
            <p>OUR POLICY - Binging quality is all we do.</p>
    </div>
